...
# downloads the qa model. using the huggingface link
#To make this image more general one can use wget with the "-i requires.txt" argument to download the necessary files defined
# in "requires.txt".
